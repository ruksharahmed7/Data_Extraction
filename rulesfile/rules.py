...
estimated_cost_re=re.compile(r'প্রকল্পের\s*ব্যয়|প্রকল্পের\s*প্রাক্কলিত\s*ব্যয়|প্রকল্পের\s*প্রাক্কলিত\s*ব্যয়|Estimated\s*(c|C)ost\s*of\s*the\s*((p|P)roject)?|মোট\s*প্রকল্প\s*ব্যয়')
...
own_fund_re=re.compile(r'নজিস্ব\s*অর্থ|DNCC|নিজস্ব\s*অর্থ|Own\s*Fund|নিজস্ব\s*অর্থ|িজস্ব\s*অথর্|ঁuঁঁিনঁজঁস্ঁ্বঁ\s*ঁঅঁথঁর্ঁ|ঁuঁঁিনঁজঁস্ঁ্বঁ ঁঅঁথঁর্ঁ')
pa_cost_re=re.compile(r'PA|RPA|P.A|P.A.|প্রকল্প\s*সাহায্য')
other_cost_re=re.compile(r'অন্যান্য|(O|o)thers|অন্যান্য')
not_applicable_re=re.compile(r'প্রযোজ্য\s*নয়|নাই|-|00.00|০০.০০|প্রযোজ্য\s*নহে')
...
#project date rules
date_re=re.compile(r'প্রকল্পের\s*বাস্তবায়নকালঃ|প্রকল্পের\s*বাস্ত্মবায়ন\s*কাল|প্রকল্পের\s*বাসত্মবায়নকাল|প্রকল্পের\s*বাস্ত্মবায়ন\s*কালঃ|প্রকল্পের\s*বাস্তবায়ন\s*কাল|প্রকল্প\s*বাস্ত্মবায়নকাল|প্রকল্পের\s*বাস্ত্মবায়নকাল|প্রকল্পের\s*মেয়াদ|Project\s*(i|I)mplementation\s*(p|P)eriod|প্রকল্পের\s*বাস্তবায়ণকাল')

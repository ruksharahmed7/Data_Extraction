...
#project date rules
date_re=re.compile(r'\tপ্রকল্পের\s*বাস্তবায়নকাল\t:|প্রকল্পের\s*বাস্তবায়নকালঃ|প্রকল্পের\s*বাস্ত্মবায়ন\s*কাল|প্রকল্পের\s*বাসত্মবায়নকাল|প্রকল্পের\s*বাস্ত্মবায়ন\s*কালঃ|প্রকল্পের\s*বাস্তবায়ন\s*কাল|প্রকল্প\s*বাস্ত্মবায়নকাল|প্রকল্পের\s*বাস্ত্মবায়নকাল|প্রকল্পের\s*মেয়াদ|Project\s*(i|I)mplementation\s*(p|P)eriod|প্রকল্পের\s*বাস্তবায়ণকাল')
